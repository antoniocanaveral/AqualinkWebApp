  ...
  return (
    <BannerWrapper>
      <Cards className="mb-70" bodyStyle={{ background: '#5F63F2', borderRadius: '10px', minHeight: '270px' }} headless>
        <Figure2>
          <img src={new URL('../../static/img/banner/1.png', import.meta.url).href} alt="" />
          <figcaption>
  ...
  return (
    <BannerWrapper>
      <Cards bodyStyle={{ borderRadius: '10px', minHeight: '270px', background: '#5F63F2' }} headless>
        <Figure3>
          <img src={new URL('../../static/img/banner/2.png', import.meta.url).href} alt="" />
          <figcaption>
    ...
    <BannerWrapper>
      <Cards bodyStyle={{ background: '#272B41', borderRadius: '10px', minHeight: '270px' }} headless>
        <Figure3 className="theme-3">
          <img src={new URL('../../static/img/banner/3.png', import.meta.url).href} alt="" />
          <figcaption>
    ...
    <BannerWrapper>
      ...
      >
        <Figure3 className="theme-wide">
          <img src={new URL('../../static/img/banner/4.png', import.meta.url).href} alt="" />
          <figcaption>
    ...
    <BannerWrapper className="ninjadash-congratulation-banner">
      ...
      >
        <Figure8 className="ninjadash-congratulation-banner-content theme-wide">
          <img src={new URL('../../static/img/trophy.png', import.meta.url).href} alt="" />
          <figcaption>
            <h2>Congratulations Jhon!</h2>
            <p>Best Seller on the last month.</p>
    ...
    <BannerWrapper className="ninjadash-card-banner">
      ...
      >
        <Figure8 className="ninjadash-card-banner-content theme-wide">
          <img src={new URL('../../static/img/trophy-2.png', import.meta.url).href} alt="" />
          <figcaption>
            <h2>Congratulations Jhon!</h2>
            <p>Best Seller on the last month.</p>
            <Button size="large" type="white">
...
function Banner6() {
  return (
    <BannerWrapper>
      <Cards
        bodyStyle={{
          background: `url(${new URL('../../static/img/banner/5.png', import.meta.url).href})`,
      ...
      >
        <Figure6>
          <img src={new URL('../../static/img/banner/badge.svg', import.meta.url).href} alt="" />
          <figcaption>
            <h2>Up to 50 OFF</h2>
...
function Banner7() {
  return (
    <BannerNormal className="theme-wide">
      <Cards headless>
        <Figure7>
          <img src={new URL('../../static/img/banner/6.png', import.meta.url).href} alt="" />
          <figcaption>
      ...
      <Carousel autoplay>
        <div className="banner-signle">
          <div className="banner-single__img">
            <img src={new URL('../../static/img/banner/8.png', import.meta.url).href} alt="" />
          </div>
  ...
  return (
    <BannerLongWrap>
      <div className="banner-long-inner">
        <h2>Up To Date </h2>
        <img src={new URL('../../static/img/banner/9.png', import.meta.url).href} alt="" />
      </div>
    </BannerLongWrap>
  );
}
  ...
  return (
    <BannerCardWrap>
      <div
        ...
        style={{ backgroundImage: `url(${new URL('../../static/img/banner/card-banner-1.png', import.meta.url).href})` }}
      >
  ...
  return (
    <BannerCardWrap>
      <div
        ...
        style={{ backgroundImage: `url(${new URL('../../static/img/banner/card-banner-2.png', import.meta.url).href})` }}
      >
  ...
  return (
    <BannerCtaWrap>
      <div
        ...
        style={{ backgroundImage: `url(${new URL('../../static/img/banner/cta-banner-1.png', import.meta.url).href})` }}
      >
  ...
  return (
    <BannerCtaWrap>
      <div
        ...
        style={{ backgroundImage: `url(${new URL('../../static/img/banner/cta-banner-2.png', import.meta.url).href})` }}
      >
        <div className="banner-cta__content">
    ...
    >
      <Cards headless>
        <PageHeader className="theme-wide">
          {type === 'corporate' ? (
            <img src={new URL('../../static/img/corporate.png', import.meta.url).href} alt="HexaDash Admin Template" />
          ) : (
            <img src={new URL('../../static/img/banner/header-banner.png', import.meta.url).href} alt="HexaDash Admin Template" />
          )}

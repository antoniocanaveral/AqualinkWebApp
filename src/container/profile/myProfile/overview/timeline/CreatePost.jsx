    ...
    <CreatePost>
      ...
      <Cards title="Post Something">
        <div onClick={() => setDrawer(true)} className="postBody">
          <img className="post-author" src={new URL('../../../../../static/img/chat-author/t4.jpg', import.meta.url).href} alt="" />
          ...
          <div className="postFooter_left">
            <Upload>
              <Button shape="circle" type="light">
                <img src={new URL('../../../../../static/img/icon/image.png', import.meta.url).href} alt="" />
                Photo/Video
              </Button>
            </Upload>

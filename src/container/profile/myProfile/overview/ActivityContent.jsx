      ...
      <Cards headless>
        <ul className="activity-list">
          <li className="activity-list__single">
            ...
            <div className="activity-content">
              <div className="activity-info">
                <img src={new URL('../../../../static/img/chat-author/t1.jpg', import.meta.url).href} alt="" />
                <p>
          ...
          <li className="activity-list__single">
            ...
            <div className="activity-content">
              <div className="activity-info">
                <img src={new URL('../../../../static/img/chat-author/t2.jpg', import.meta.url).href} alt="" />
                <p>
          ...
          <li className="activity-list__single">
            ...
            <div className="activity-content">
              <div className="activity-info">
                <img src={new URL('../../../../static/img/chat-author/t3.jpg', import.meta.url).href} alt="" />
                <p>
          ...
          <li className="activity-list__single">
            ...
            <div className="activity-content">
              <div className="activity-info">
                <img src={new URL('../../../../static/img/chat-author/t4.jpg', import.meta.url).href} alt="" />
                <p>
                  <span className="inline-text color-primary">James</span> Send you a message{' '}
                  <span className="hour">5 hours ago</span>
                </p>
          ...
          <li className="activity-list__single">
            ...
            <div className="activity-content">
              <div className="activity-info">
                <img src={new URL('../../../../static/img/chat-author/t5.png', import.meta.url).href} alt="" />
                <p>
                  <span className="inline-text color-primary">Adam</span> upload website template for sale{' '}
                  <span className="hour">5 hours ago</span>
                </p>
          ...
          <li className="activity-list__single">
            ...
            <div className="activity-content">
              <div className="activity-info">
                <img src={new URL('../../../../static/img/chat-author/t6.png', import.meta.url).href} alt="" />
                <p>
                  <span className="inline-text color-primary">James</span> Send you a message{' '}
                  <span className="hour">5 hours ago</span>
                </p>
          ...
          <li className="activity-list__single">
            ...
            <div className="activity-content">
              <div className="activity-info">
                <img src={new URL('../../../../static/img/chat-author/t7.png', import.meta.url).href} alt="" />
                <p>
                  <span className="inline-text color-primary">Mumtahin</span> has registered{' '}
                  <span className="hour">5 hours ago</span>
                </p>
          ...
          <li className="activity-list__single">
            ...
            <div className="activity-content">
              <div className="activity-info">
                <img src={new URL('../../../../static/img/chat-author/t8.png', import.meta.url).href} alt="" />
                <p>
                  <span className="inline-text color-primary">Adam</span> upload website template for sale{' '}
                  <span className="hour">5 hours ago</span>
                </p>

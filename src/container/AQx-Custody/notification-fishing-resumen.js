...
function NotificationFishingResumen() {
  ...
  return (
    <>
      <Main>
        <Row gutter={25}>
          <Col sm={24} xs={24}>
            <Cards title="Notificaciones de Pesca">
              ...
              <Row gutter={25}>
                ...
                <Col span={6}>
                  {/* Para la fecha */}
                  <p>
                    <strong>Pesca: {moment().format('DD MMM YYYY')} / 08:00AM</strong><br />
                  </p>
                </Col>
              </Row>
              ...
              <Row gutter={25}>
                ...
                <Col xl={5} xs={24}>
                  <p className="p_box_notification">
                    <strong>Código de Pesca A365EC</strong><br />
                    Textura: 91-95%<br />
                    Días de Cultivo: 87<br />
                    Punto de Pesca: COJIMÍES
                  </p>
                </Col>
              </Row>
...
export default NotificationFishingResumen;

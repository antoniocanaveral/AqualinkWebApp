    ...
    <Cards title={title}>
      <div className="file-list">
        <div className="file-list__single d-flex">
          <div className="file-single-info d-flex">
            <div className="file-single-logo">
              <img src={new URL(`../../../static/img/files/zip.png`, import.meta.url).href} alt="File Logo" />
            </div>
        ...
        <div className="file-list__single d-flex">
          <div className="file-single-info d-flex">
            <div className="file-single-logo">
              <img src={new URL(`../../../static/img/files/pdf.png`, import.meta.url).href} alt="File Logo" />
            </div>
            <div className="file-single__content">
        ...
        <div className="file-list__single d-flex">
          <div className="file-single-info d-flex">
            <div className="file-single-logo">
              <img src={new URL(`../../../static/img/files/psd.png`, import.meta.url).href} alt="File Logo" />
            </div>
            <div className="file-single__content">
        ...
        <div className="file-list__single d-flex">
          <div className="file-single-info d-flex">
            <div className="file-single-logo">
              <img src={new URL(`../../../static/img/files/jpg.png`, import.meta.url).href} alt="File Logo" />
            </div>
            <div className="file-single__content">
        ...
        <div className="file-list__single d-flex">
          <div className="file-single-info d-flex">
            <div className="file-single-logo">
              <img src={new URL(`../../../static/img/files/png.png`, import.meta.url).href} alt="File Logo" />
            </div>
            <div className="file-single__content">

        ...
        <BasicFormWrapper>
          <Form form={form} name="createProject" onFinish={handleOk}>
            ...
            <div className="projects-members mb-30">
              <img style={{ width: '35px' }} src={new URL(`../../../static/img/users/1.png`, import.meta.url).href} alt="" />
              <img style={{ width: '35px' }} src={new URL(`../../../static/img/users/2.png`, import.meta.url).href} alt="" />
              <img style={{ width: '35px' }} src={new URL(`../../../static/img/users/3.png`, import.meta.url).href} alt="" />
              <img style={{ width: '35px' }} src={new URL(`../../../static/img/users/4.png`, import.meta.url).href} alt="" />
              <img style={{ width: '35px' }} src={new URL(`../../../static/img/users/5.png`, import.meta.url).href} alt="" />
            </div>
            <Row gutter={15}>
              <Col md={12} xs={24}>

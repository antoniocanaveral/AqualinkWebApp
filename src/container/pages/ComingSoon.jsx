              ...
              <Cards headless>
                <div className="ninjaDash-logo">
                  {mainContent === 'lightMode' ? (
                    <img src={new URL('../../static/img/AQx-IMG/aqualink-dark.svg', import.meta.url).href} alt="" />
                  ) : (
                    <img src={new URL('../../static/img/AQx-IMG/aqualink-lite.svg', import.meta.url).href} alt="" />
                  )}
                </div>

            ...
            <BlogDetailsStyle>
              <div className="ninjadash-blog-details">
                <div className="ninjadash-blog-featured-img">
                  <img src={new URL(`../../../static/img/blogs/blog-details/1.png`, import.meta.url).href} alt="ninjadash Blog" />
                </div>
                <div className="ninjadash-blog-content-box">
                  <div className="ninjadash-blog-content">
                    ...
                    <ul className="ninjadash-blog-meta">
                      <li className="ninjadash-blog-meta__author">
                        <img src={new URL(`../../../static/img/users/1.png`, import.meta.url).href} alt="ninjadash blog author" />
                    ...
                    <img src={new URL(`../../../static/img/blogs/blog-details/2.png`, import.meta.url).href} alt="ninjadash Blog" />
                      ...
                      <div className="ninjadash-blog-blockquote">
                        <p>
                          <img
                            ...
                            src={new URL(`../../../static/img/icon/quote-left.png`, import.meta.url).href}
                          ...
                          <img
                            ...
                            src={new URL(`../../../static/img/icon/quote-right.png`, import.meta.url).href}
                            alt="ninjadash blockquote"
                          />
                        </p>
                  ...
                  <div className="ninjadash-blog-author-box">
                    <div className="ninjadash-blog-author-img">
                      <img src={new URL(`../../../static/img/users/1.png`, import.meta.url).href} alt="ninjadash Blog" />
                    </div>

                      ...
                      <div className="ninjadash-ticket-file-item d-flex">
                        <div className="ninjadash-ticket-file-item__info d-flex">
                          <div className="ninjadash-ticket-file-item__logo">
                            <img
                              style={{ width: '40px' }}
                              src={new URL(`../../static/img/files/zip.png`, import.meta.url).href}
                              alt="File Logo"
                            />
                          </div>
                      ...
                      <div className="ninjadash-ticket-file-item d-flex">
                        <div className="ninjadash-ticket-file-item__info d-flex">
                          <div className="ninjadash-ticket-file-item__logo">
                            <img
                              style={{ width: '40px' }}
                              src={new URL(`../../static/img/files/pdf.png`, import.meta.url).href}
                              alt="File Logo"
                            />
                          </div>
                          <div className="ninjadash-file-item__content">
                      ...
                      <div className="ninjadash-ticket-file-item d-flex">
                        <div className="ninjadash-ticket-file-item__info d-flex">
                          <div className="ninjadash-ticket-file-item__logo">
                            <img
                              style={{ width: '40px' }}
                              src={new URL(`../../static/img/files/psd.png`, import.meta.url).href}
                              alt="File Logo"
                            />
                          </div>

...
function AnalyticReportFarm() {
    ...
    console.log(farmsOrgsWithPools
        .find(org => org.orgId === selectedOrg)?.pools
        .filter(pool => pool.salesRegion && pool.salesRegion.id === selectedSector))
    ...
    function getCiclosValues(reports, extractorFn) {
        const result = {};
        for (let i = 0; i < 5; i++) {
            const report = reports[i];
            result[`ciclo${i + 1}`] = report ? extractorFn(report) || '' : '';
        }
        return result;
    }
    ...
    const mainTableData = [
        ...
        },
        {
            ...
            ...getCiclosValues(productionReports, r =>
                ...
                (r.poolsize_prefattening || 0) +
                (r.poolsize_mwarehouse || 0)
            ),
        },


        /*VARIABLES DE PRODUCCION PRECRIA*/
        ...
        {
            key: 'poolsize_mwarehouse',
            descripcion: 'Desidad de Siembra',
            ...getCiclosValues(productionReports, r => r.pc_production_json.stocking_population),
        },
        {
            key: 'poolsize_mwarehouse',
            descripcion: 'Desidad por Ha(Pre cría)',
            ...getCiclosValues(productionReports, r =>
                (r.pc_production_json.stocking_population || 0) /
                (r.poolsize_prebreeding || 0)
            ),
        },
        {
            key: 'poolsize_mwarehouse',
            descripcion: 'Desidad de Siembra en Pre Cría por m2',
            ...getCiclosValues(productionReports, r =>
                (r.pc_production_json.stocking_population || 0) /
        ...
        },
        {
            ...
            ...getCiclosValues(productionReports, r => r.superv
            ),
        },
        {
            key: 'poolsize_mwarehouse',
        ...
        {
            key: 'poolsize_mwarehouse',
            descripcion: 'Alimento total Pre Cría',
        ...
        /*VARIABLES DE PRODUCCION PRE ENGORDE*/
        ...
        /*VARIABLES DE PRODUCCION ENGORDE*/

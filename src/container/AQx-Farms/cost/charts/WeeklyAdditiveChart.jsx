...
export default function WeeklyAdditiveChart({ dataSource, height = 300 }) {
    ...
    console.log("Semanas:", weeks); // Verifica la estructura de las semanas
    const weeklyData = weeks.map((week) => {
        const balanceado = week.reduce((total, day) => total + day.aditivos, 0);
        return balanceado;
    });
    ...
    const data = {
        ...
        datasets: [
            ...
            },
            {
                ...
                label: 'Insumos',
                data: weeklyData,
                backgroundColor: '#bf5757', // Color para las barras
                barPercentage: 0.6,

            ...
            <Form form={form} name="promo" onFinish={submitPromo}>
              <Form.Item name="couponType" initialValue="" label="">
                <Select style={{ width: '100%' }}>
                  <Option value="">
                    <img src={new URL('../../../static/img/Subtraction1.png', import.meta.url).href} alt="" /> Select Coupon
                  </Option>
                  <Option value="one">
                    <img src={new URL('../../../static/img/Subtraction1.png', import.meta.url).href} alt="" /> Coupon one
                  </Option>
                  <Option value="tow">
                    <img src={new URL('../../../static/img/Subtraction1.png', import.meta.url).href} alt="" /> Coupon tow
                  </Option>
                </Select>
              </Form.Item>

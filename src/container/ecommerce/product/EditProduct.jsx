...
function EditProduct() {
  ...
  const fileList = [
    {
      ...
      name: 'xxx.png',
      status: 'done',
      url: new URL('../../../static/img/products/1.png', import.meta.url).href,
      thumbUrl: new URL('../../../static/img/products/1.png', import.meta.url).href,
    },
  ];
  ...
  return (
    <>
      <PageHeader  title="Edit Product" routes={PageRoutes} />
      <Main>
        <Row gutter={15}>
          <Col xs={24}>
            <Cards headless>

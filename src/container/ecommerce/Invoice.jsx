...
function Invoice() {
  ...
  return (
    <div className="invoice-area">
      <PageHeader  title="Invoice" routes={PageRoutes} />
      <Main>
        <Row gutter={15}>
          <Col md={24}>
            <Cards headless>
                    ...
                    <Col sm={12} xs={24}>
                      <figure className="company-logo">
                        {mainContent === 'lightMode' ? (
                          <img src={new URL('../../static/img/logo_dark.svg', import.meta.url).href} alt="" />
                        ) : (
                          <img src={new URL('../../static/img/logo_white.svg', import.meta.url).href} alt="" />
                        )}
                      </figure>
                    </Col>
                    <Col sm={12} xs={24}>
                ...
                <InvoiceLetterBox>
                  <div className="invoice-letter-inner">
                    ...
                    <div className="invoice-barcode">
                      <Cards headless>
                        {mainContent === 'lightMode' ? (
                          <img style={{ width: '100%' }} src={new URL('../../static/img/barcode.png', import.meta.url).href} alt="barcode" />
                        ) : (
                          <img style={{ width: '100%' }} src={new URL('../../static/img/bar-dark.png', import.meta.url).href} alt="barcode" />
                        )}

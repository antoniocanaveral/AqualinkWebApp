...
import { Tabs, Form, Input, Select, Button, Upload, InputNumber, Row, Col, Switch, message, Typography, Table, Modal, Card } from 'antd';
                ...
                <Form form={form} layout="vertical" onFinish={(values) => console.log('Formulario completado:', values)}>
                    <Tabs activeKey={activeTab} type="line">
                        ...
                        <TabPane tab="Georeferenciación" key="3">
                            <Card>
                                <Form.Item
                                    label="Seleccionar un Laboratorio para Georeferenciación"
                                    name="georeferenciacionPiscina"
                                    rules={[{ required: true, message: "Seleccione un identificador de Laboratorio" }]}
                                >
                                    <Select

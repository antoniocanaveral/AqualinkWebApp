...
import WeeklyFoodChart from './charts/WeeklyFoodChart';
  ...
  return (
    <>
      ...
      <Row gutter={25}>
        ...
        <Col xl={8} xs={24} style={{ display: "flex" }}>
          <Suspense fallback={<Cards headless><Skeleton active /></Cards>}>
            <Cards title="Alimento Semanal" size="large">
              <WeeklyFoodChart dataSource={dataSource} />
            </Cards>
          </Suspense>
        </Col>
        <Col xl={8} xs={24} style={{ display: "flex" }}>
          <Suspense fallback={<Cards headless><Skeleton active /></Cards>}>
            <Cards title="Aditivo Semanal" size="large">
              <WeeklyFoodChart dataSource={dataSource} />
            </Cards>

...
import { addProductToInventory, fetchProductCatalogLab } from '../../../redux/inventory/actionCreator.js';
import { selectLabOrgsWithWarehouses } from '../../../redux/authentication/selectors.js';
import Cookies from 'js-cookie';
import { fetchDirectories } from '../../../redux/directories/actionCreator.js';
...
function AddInventoryLabs() {
  ...
  const poolsOptions =
    selectedOrg && farmsOrgsWithPools
      ...
      : [];
  console.log("OAKDKASDOAS", poolsOptions)
  const custodyOrgs = useSelector((state) => state.auth.labsOrgs);
  ...
  useEffect(() => {
    dispatch(fetchProductCatalogLab());
  ...
  const handleSubmit = async (values) => {
    ...
    console.log("pooldaa", selectedPoolData)

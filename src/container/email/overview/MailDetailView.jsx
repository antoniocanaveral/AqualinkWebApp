...
function Single() {
  ...
  const ReplayMess = React.memo((value) => {
    return (
      <>
        <img style={{ width: 50, height: 50 }} src={new URL('../../../static/img/email/2.png', import.meta.url).href} alt="" />
              ...
              <div className="message-attachments">
                <figure>
                  <div className="attachment-image">
                    <img src={new URL('../../../static/img/email/2.png', import.meta.url).href} alt="" />
                  </div>
                ...
                <figure>
                  <div className="attachment-image">
                    <img src={new URL('../../../static/img/email/1.png', import.meta.url).href} alt="" />
                  </div>
                  <div className="attachment-hover">
                    <Link className="btn-link" to="#">
                      <UilImport />
                ...
                <figure>
                  <div className="attachment-image">
                    <img src={new URL('../../../static/img/email/3.png', import.meta.url).href} alt="" />
                  </div>
                  <div className="attachment-hover">
                    <Link className="btn-link" to="#">
                      <UilImport />
                ...
                <figure>
                  <div className="attachment-image">
                    <img src={new URL('../../../static/img/email/4.png', import.meta.url).href} alt="" />
                  </div>
                  <div className="attachment-hover">
                    <Link className="btn-link" to="#">
                      <UilImport />

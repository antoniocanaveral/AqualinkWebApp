import{s as n}from"./index-BJIB_XH5.js";const a=n.div`
...
`,r=n.div`
    ...
    h1{
        ...
        border-top: 1px solid ${({theme:t})=>t[t.mainContent]["border-color-secondary"]};
        padding: 15px 0 20px;
        color: ${({theme:t})=>t[t.mainContent]["dark-text"]};
    }
`,e=n.div`
        ...
        ul{
            li{
                ...
                &:after{
                    ...
                    border-radius: 50%;
                    content: '';
                    background-color: ${({theme:t})=>t[t.mainContent]["gray-text"]};
                }
                &:not(:last-child){
                    margin-bottom: 12px;
                }
...
`,l=n.div`
    ...
    .ant-form-item-control-input-content{
        ...
        .ant-upload-select{
            width: 100%;
            padding: 12px 14px;
            border: 1px dashed ${({theme:t})=>t[t.mainContent]["border-color-secondary"]};
            .ant-btn{
                &.ant-btn-sm{
                    padding: 0px 13.75px;
                    height: 38px;
...
`;n.div`
    ...
    .pdbr__Actions{
        border-bottom: 1px solid ${({theme:t})=>t[t.mainContent]["general-background"]};
        padding-bottom: 30px;
        margin-bottom: 28px;
        @media only screen and (max-width: 1399px){
            flex-flow: column;
        ...
        .pdbr__product-action{
            ...
            .btn-icon{
                height: 44px;
                padding: 0 13px;
                box-shadow: 0 5px 15px ${({theme:t})=>t[t.mainContent]["light-text"]}15;
                &:hover{
...
`;n.div`
    ...
    .add-product-block{
        ...
        border-radius: 20px;
        padding: 30px;
        border: 1px solid ${({theme:t})=>t[t.mainContent]["main-background-light"]};
        @media only screen and (max-width: 575px){
            padding: 20px;
        }
        &:not(:last-child){
...
`;export{x as A,a as J,r as N,g as P,o as S,p as a,l as b,e as c,d};

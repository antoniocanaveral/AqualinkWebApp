import{j as e,L as i,s as l,ay as m,B as k,Q as y,dM as q,X as h,aQ as u,bV as j,r as U,b$ as J,t as R,P as $,M as P,e as x,f as a,dN as _,dO as C,w as H,V as T}from"./index-B54C9UsK.js";import W from"./TeamCard-D9eVV7BD.js";import L from"./UserCard-Cijnb7_M.js";import O from"./GridCard-d3J0Utv7.js";import{P as z}from"./ProductCards-B4UEthTZ.js";import{P as D}from"./ProductCardList-D6KTXi-5.js";import Z from"./GalleryCard-BJNJCNqD.js";import{C as G}from"./ContactCard-NynAVM3m.js";import{c as M,B as F}from"./sampleCards-C_qmlQRL.js";import{F as f}from"./FileListCard-C3C51LbV.js";import"./index-dukHIMAM.js";import"./utilities-DrZkDkFt.js";import"./style-CxodRn2N.js";import"./Style-DimRgoaT.js";import"./actionCreator-DiHqgHMS.js";import"./index-D45eQrrU.js";import"./StarFilled-BJ9nENpS.js";import"./style-CkfsZamn.js";import"./actionCreator-3GAXUcrQ.js";const K=l.figure`
...
`;function I({item:t}){const{content:s,title:n,img:o}=t;return e.jsxs(Y,{children:[e.jsx("img",{src:require(`../../../${o}`),alt:""}),e.jsxs("figcaption",{children:[e.jsx("h2",{children:n}),e.jsx("p",{children:s})]})]})}I.propTypes={item:m.object};I.defaultProps={item:{id:1,title:"User Friendly",content:"Lorem Ipsum is simply dummy text of the",img:"static/img/sampleCards/1.svg"}};const X=l.figure`
  background: ${({theme:t})=>t[t.mainContent]["white-background"]};
  border-radius: 10px;
  overflow: hidden;
  margin-bottom: 0;

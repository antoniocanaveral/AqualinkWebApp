...
import ProtectedFirebaseRoute from './components/utilities/ProtectedFIrebaseROute';
import KnowledgeCenter from './container/AQx-Knoledge-Center/knoledgeCenter';
        ...
        <Router basename={import.meta.env.VITE_PUBLIC_URL}>
          ...
          {!isLoggedIn || !selectedRoleId ? (
            <Routes>
              ...
              <Route path="/knoledge-center" element={<ProtectedFirebaseRoute Component={KnowledgeCenter} />} />
            </Routes>
          ) : isAuditorExterno ? (
            <Routes>
              {!hasSelectedOrg ? (
